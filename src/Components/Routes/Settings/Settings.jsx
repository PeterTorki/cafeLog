...
export default function Settings() {
  ...
  const AccountChanges = () => {
    return (
      <div className={Style.Accountcontainer}>
        ...
        {/*  Sumbit Buutom and change into jsopn file */}
        <center>
          <br />
  ...
  const printDate = () => {
    ...
    for (let i = times.length - 1; i >= 0; i--) {
      arr.push(
        <div
          key={nanoid()}
          onClick={() => setActiveDataIndex(i)}
          className={[
            Style.date,
            activeDataIndex === i ? Style.active : Style.notActive,
          ].join(" ")}
        >
          {times[i]}
        </div>
  ...
  const LegalNotes = () => {
    return (
      <div className={Style.NotesOuter}>
        <div className={Style.Notes}>
          ...
          <ul>
            <li>By email: office@chillcup.com</li>
          </ul>
        </div>
      </div>
    );
    ...
    <div className={Style.outer}>
      <div className={Style.content}>
        <div className={Style.leftSide}>
          ...
          >
            <center>
              <FontAwesomeIcon
                icon={faUserCog}
                className={Style.myicons}
              ></FontAwesomeIcon>
            </center>
          </button>
          <button
            className={
              activeContentIndex === 1 ? Style.active : Style.notActive
            }
          ...
          <button
            className={
              activeContentIndex === 2 ? Style.active : Style.notActive
            }
        ...
        <div className={Style.rightSide}>
          ...
          {activeContentIndex === 1 ? PrevOrders() : null}
          {activeContentIndex === 2 ? LegalNotes() : null}
        </div>
      </div>
    </div>
  );
